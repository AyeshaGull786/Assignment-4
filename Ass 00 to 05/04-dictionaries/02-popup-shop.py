...
# Problem Statement
# There's a small fruit shop nearby your house that you like to buy from. Since you buy several fruit at a time, you want
...
def main():
    fruits = {'apple': 1.5, 'grapes': 50, 'banana': 80, 'kiwi': 1, 'pineapple': 1.5, 'mango': 5 , 'melon': 6}
