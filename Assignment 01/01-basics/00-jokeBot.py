...
# PROMPT JOKE SORRY
# which contain the strings for the prompt asked to the user, the joke to print out if the user enters Joke and the sorry message if the
# user enters anything else.
# Your program will need to use an if statement which checks if the user input is Joke:
# if user_input == "Joke":
# Recall that == is a comparison which tests if two values are equal to one another.
# Here is a full run of the program (user input is in blue):
# What do you want? Joke Here is a joke for you! Panaversity GPT - Sophia is heading out to the grocery store. A programmer tells 
# her: get a liter of milk, and if they have eggs, get 12. Sophia returns with 13 liters of milk. The programmer 
...
def joke_bot():
    """Asks the user what they want and responds with a joke or an apology."""
    user_input = input(PROMPT).strip()  # Get user input and remove extra spaces
    
    if user_input == "jokes":
        print(JOKE)  # Print the joke if user asks for it
    else:
